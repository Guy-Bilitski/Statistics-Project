...
```{r}
mat <- cbind("התקופה שלפני השיתוק" = early_knsts_props, "תקופת השיתוק" = later_knsts_props)
boxplot(mat, main = "התפלגות פרופורציית התפקידים של גוש המפלגות הקטנות (1)", ylab = "פרופורציה", )
...
boxplot(smallCount_InKnesset[1:20],
        ...
        main = 'התפלגות מספר חברי המפלגות הקטנות מתוך הכנסת (2)', ylab = 'חברי כנסת',
        names = c("התקופה שלפני השיתוק", "תקופת השיתוק"))
```
...
boxplot(smallRate_New[1:20], smallRate_New[21:24],
        ...
        names = c("התקופה שלפני השיתוק", "תקופת השיתוק"), ylab ='פרופורציה')
